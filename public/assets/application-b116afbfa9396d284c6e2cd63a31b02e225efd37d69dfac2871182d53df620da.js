...
(function() {
  $(document).on("click", "#show_duration", function(e) {
    event.preventDefault();
    return window.location.href = "/?duration=" + $('#duration').val() + "days";
  });

  $(document).on("click", "#download", function(e) {
    event.preventDefault();
    return window.location.href = "https://blockchain.info/charts/market-price?showDataPoints=false&timespan=" + $('#duration').val() + "days&show_header=true&daysAverageString=1&scale=0&format=csv&address=";
  });

  $(document).on("click", "#timeseries_menu", function(e) {
    event.preventDefault();
    if (location.href.match(/herokuapp.com/)) {
      return window.location.href = "#timeseries";
    } else {
      return $("html,body").animate({
        scrollTop: $('#timeseries').offset().top - 70
      });
    }
  });

  $(document).on("click", "#stats_menu", function(e) {
  ...
  $(document).on("click", "#bep_menu", function(e) {
    event.preventDefault();
    return $("html,body").animate({
      scrollTop: $('#bep').offset().top - 70
    });
  });

  $(document).on("click", "#raw_data_menu", function(e) {
    event.preventDefault();
    return $("html,body").animate({
      scrollTop: $('#raw_data').offset().top - 70
    });
  });
